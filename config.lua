...
Config.blipAllowedClosed = true -- Show or Remove Blip when Closed
...
Config.Stores = {
    Valentine = {
        ...
        blipColorOpen = "BLIP_MODIFIER_MP_COLOR_32", -- White
        blipColorClosed = "BLIP_MODIFIER_MP_COLOR_10", -- Red
		blipColorJob = "BLIP_MODIFIER_MP_COLOR_23", -- Yellow
        storeName = "valentine",
